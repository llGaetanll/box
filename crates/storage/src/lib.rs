...
impl ChunkStore {
    ...
    pub fn save_chunk(&mut self, pos: ChunkPos, tree: &tree64::Tree64<u8>) -> Result<()> {
        let mut buf = Vec::new();
    ...
    pub fn load_chunk(&mut self, pos: ChunkPos) -> Result<Option<tree64::Tree64<u8>>> {
        let region_pos = chunk_to_region(pos);
        let slot = chunk_to_slot(pos);
        ...
        let tree = tree64::Tree64::deserialize(io::Cursor::new(data)).map_err(StorageError::Io)?;
        Ok(Some(tree))
    }
...
mod tests {
    ...
    fn test_chunk_store_roundtrip() {
        ...
        let values = [1_u8; 64];
        let tree = tree64::Tree64::new((&values[..], [4, 4, 4]));
    ...
    fn test_chunk_store_multiple_regions() {
        ...
        let tree_a = tree64::Tree64::new((&[1_u8; 64][..], [4, 4, 4]));
        let tree_b = tree64::Tree64::new((&[2_u8; 64][..], [4, 4, 4]));
    ...
    fn test_chunk_store_remove() {
        ...
        let tree = tree64::Tree64::new((&[1_u8; 64][..], [4, 4, 4]));
        let pos: ChunkPos = [0, 0, 0];
    ...
    fn test_chunk_store_persistence() {
        ...
        let tree = tree64::Tree64::new((&[3_u8; 64][..], [4, 4, 4]));
